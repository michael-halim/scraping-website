...
def main():
    ...
    print_help(var='RUNNING AER PALOMA WEB SCRAPING....', title='AER PALOMA WEB SCRAPING', username='MAIN')
    ...
    print_help(var='FINISHED AER PALOMA WEB SCRAPING....', title='AER PALOMA WEB SCRAPING', username='MAIN')
