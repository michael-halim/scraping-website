...
def main():
    ...
    print_help(var='RUNNING AER PALOMA WEB SCRAPING....', title='AER PALOMA WEB SCRAPING', username='MAIN', save_log_path=SAVE_LOG_PATH, log_filename=LOG_FILENAME)
    ...
    print_help(var='FINISHED AER PALOMA WEB SCRAPING....', title='AER PALOMA WEB SCRAPING', username='MAIN', save_log_path=SAVE_LOG_PATH, log_filename=LOG_FILENAME)
