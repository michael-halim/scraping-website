...
def main():
    ...
    print_help(var='RUNNING AER DOBIDOS WEB SCRAPING....', title='AER DOBIDOS WEB SCRAPING', username='MAIN')
    ...
    print_help(var='FINISHED AER DOBIDOS WEB SCRAPING....', title='AER DOBIDOS WEB SCRAPING', username='MAIN')
