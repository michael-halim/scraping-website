...
def main():
    ...
    print_help(var='RUNNING AER DEKORUMA WEB SCRAPING....', title='AER DEKORUMA WEB SCRAPING', username='MAIN')
    ...
    print_help(var='FINISHED AER DEKORUMA WEB SCRAPING....', title='AER DEKORUMA WEB SCRAPING', username='MAIN')
