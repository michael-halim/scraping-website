...
def main():
    ...
    print_help(var='RUNNING AER TEKA WEB SCRAPING....', title='AER TEKA WEB SCRAPING', username='MAIN')
    ...
    print_help(var='FINISHED AER TEKA WEB SCRAPING....', title='AER TEKA WEB SCRAPING', username='MAIN')
