...
def main():
    ...
    print_help(var='RUNNING AER GREE WEB SCRAPING....', title='AER GREE WEB SCRAPING', username='MAIN')
    ...
    print_help(var='FINISHED AER GREE WEB SCRAPING....', title='AER GREE WEB SCRAPING', username='MAIN')
