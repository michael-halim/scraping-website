SohoID_MATERIAL_REPLACE = {
    ...
    'Rangka Kayu,Busa,Kain Linen,Per,Kaki Stainless':'wood,foam,linen,spring,stainless',
    'untuk kenyamanan Anda dengan sandaran melengkung,kaki kayu,dudukan jok yang sempurna sebagai kursi di ruang makan,ruang keluarga ataupun di kamar tidur untuk menemani meja rias kamu':'wood',
    'Rangka Kayu,Busa,Kain Linen,Per':'wood,foam,linen,spring',
    'Rangka Kayu,Busa,Kain Linen':'wood,foam,linen',
    'mdf,laci kayu,duco paint Tidak termasuk kursi (hanya meja,laci saja':'mdf,wood,duco paint',
...
SohoID_COLOR_REPLACE = {
    ...
    'dapat disesuaikan dengan berbagai warna furniture anda.':'custom',
    'menarik':'bright',
}